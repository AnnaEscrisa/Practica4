...
<main class="home_main materials">
    ...
    <section class="cards_container">
        ...
        foreach (['1', '2'] as $mat): ?>
            ...
            <div class="grid_card">
                <article class="article_card" onclick="showSidebar(<?= htmlspecialchars($mat) ?>, 'material')">
                    <img src='public/img/gui/none.webp' alt="Imatge no disponible">
    ...
    <section class="pages">
        ...
        <a href="" class="button button-lil">
            ←
        </a>
